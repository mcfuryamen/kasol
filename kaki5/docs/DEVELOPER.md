...
Versi acuan: **v183 / 1.0.108 (2026-09-07)**. Setiap klaim disertai `file:baris`.
...
<script type="module" src="js/app.js?v=183"></script>  <!-- :1014 entry -->
...
```
                    ...
                    └───────────────┬──────────────────────────┘
                                    │ dexie.min.js (global) → app.js?v=183 (ESM)
                    ┌───────────────▼──────────────────────────┐
                    │  app.js  — entry                          │
...
*Terakhir diselaraskan dengan kode: **v183 / 1.0.108, 2026-09-07**.*
