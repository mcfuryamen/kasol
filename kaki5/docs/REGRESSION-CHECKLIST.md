...
|---|---|---|
| 1 | `js/version.js` → `APP_VERSION` (`:7`) | `1.0.108` |
| 2 | `js/version.js` → `CACHE_BUST` (`:18`) | `v183` |
| 3 | `js/version.json` → `"version"` (`:2`) | `1.0.108` |
| 4 | `js/version.json` → `"cacheBust"` (`:3`) | `v183` |
| 5 | `sw.js` → `CACHE_NAME` (`:201`) **dan** komentar "Cache version vNNN" (`:4`) + blok catatan rilis (`:7-191`) | `kasir-solo-kaki5-v183` |
| 6 | `index.html` → `js/app.js?v=` (`:1014`) | `?v=183` |
