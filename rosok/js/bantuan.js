/* =========================================================================
   ...
   Riwayat versi BUKAN tab — sheet #sheetChangelog, pemicunya baris "Versi …"
   di Pengaturan → Tentang Aplikasi (restruktur pemilik 2026-09-14).
...
const TUTORIALS = [
  ...
  },
  {
    ...
    content: `
      ...
      <p class="tut-note">🔄 Aplikasi memeriksa rilis baru sendiri. Bila muncul <b>"Ada Versi Baru! 🔄"</b>, tekan <b>"OKE, Perbarui Sekarang"</b> — aplikasi memuat ulang ke versi terbaru; riwayat perubahan tiap versi bisa dibaca lewat baris <b>"Versi …"</b> di <b>Pengaturan → Tentang Aplikasi</b>.</p>
    `
  },
  {
    icon: '📖',
